...
interface PagoProveedorModalProps {
  ...
  onSave: (facturaId: string, pago: Omit<PagoProveedor, 'id' | 'facturaId' | 'fechaCreacion'>) => Promise<void>;
  formasPago: FormaPago[];
  generarAsientoAutomatico?: boolean;
}

export const PagoProveedorModal: React.FC<PagoProveedorModalProps> = ({
  isOpen,
  onClose,
  factura,
  onSave,
        ...
        <div className="p-6 bg-gray-50 border-b border-gray-200">
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-gray-900">{factura.proveedor.nombre}</p>
            </div>
            <div>
